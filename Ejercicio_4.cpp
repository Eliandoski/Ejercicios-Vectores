...
int EncontrMayor(int vector[], int total) {
    int mayor = vector[0]; 
...
int main() {
    ...
    int mayor1 = EncontrMayor(vector1, total1); 
    cout << "El elemento mayor del Vector Nº1 es: " << mayor1 << endl;
    ...
    int mayor2 = EncontrMayor(vector2, total2);
    cout << "El elemento mayor del Vector Nº2 es: " << mayor2 << endl;
